...
/// `openWindow(id:)` for replay. It uses the same full-size transparent title-bar
/// treatment as BYOKchat's main macOS window while retaining native traffic lights.
@MainActor
